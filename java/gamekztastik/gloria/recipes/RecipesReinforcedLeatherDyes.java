package gamekztastik.gloria.recipes;
...
public class RecipesReinforcedLeatherDyes extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe> implements IRecipe
{
    @Override
        ...
        for (int i = 0; i < inv.getSizeInventory(); ++i)
        {
            ...
            if (!itemstack1.isEmpty())
            {
                if (itemstack1.getItem() instanceof ItemArmor)
                {
                    ...
                    if (itemarmor.getArmorMaterial() != ItemInit.ARMOR_REINFORCEDLEATHER || !itemstack.isEmpty())
                    {
                        return false;
                    }
